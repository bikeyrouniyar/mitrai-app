...
public class TopicWiseConsume {
    ...
    @KafkaListener(topics = Constants.SOURCE_TOPIC, groupId = "mitrai")
    ...
    @KafkaListener(topics = {Constants.SOURCE_TOPIC, Constants.ODD_TOPIC, Constants.EVEN_TOPIC}, groupId = "mitrai")
